...
Alberta {data-navmenu="Region Maps"}
=====================================  
...
knitr::include_url("maps/alberta_en.html", height = "100%") 
...
This interactive bilingual map shows the names, locations, and language abilities of family physicians who serve the community in Alberta. **Please note:** This map does not provide any information about which physicians are taking on new patients.
...
This data was collected from the College of Physicians and Surgeons of Alberta (CPSA) in winter/spring of 2023. This data is reviewed and updated from time to time for accuracy, but there may be errors or incomplete data. 
